...
public interface CardioCalculator {
  ...
  /** LVMI calcLeftVentricularEndDiastolicDimensionMassIndexedToBodySurfaceArea
   * Property key: examination.echotte.lvmi.expression*/
  ...
  /** LVM calcLeftVentricularMass
   * Property key: examination.echotte.lvm.expression
   * */
  ...
  /** BSA calcBodySurfaceArea
   * Property key: examination.echotte.bsa.expression*/
  double calcBodySurfaceArea(double heightInCm, double weightInKg) throws IllegalArgumentException;

  /** RWT calcRelativeWallThicknessRwt
   * Property key: examination.echotte.rwt.expression*/
