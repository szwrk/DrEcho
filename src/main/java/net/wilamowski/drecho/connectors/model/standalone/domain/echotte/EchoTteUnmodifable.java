...
///////////////////////////////////////////////////////////////////////
  ...
  EchoTteUnmodifable(int dm_name , int dm_left_ventricle , int dm_left_ventricle_systole , int dm_left_ventricle_diastole , int dm_left_atrium , int dm_left_atrium_width , int dm_left_atrium_length , int dm_aorta , int dm_right_ventricle , int dm_right_ventricle_systole , int dm_right_ventricle_diastole , int dm_right_atrium , int dm_right_atrium_width , int dm_right_atrium_length , int dm_pulmonary_trunk , int dm_iv_septum_IVS , int dm_iv_septum_diastole , int dm_iv_septum_systole , int dm_Stringterior_wall , int dm_Stringterior_wall_diastole , int dm_Stringterior_wall_systole , int dm_mass_LVM , int dm_lvmi , int dm_relative_wall_thickness , String dm_note_txt , int mv_peak_regur_vel , int mv_ea_early_to_latediast_trans_mitral_flow_vel , int mv_eeprim_early_diastolic_mitral_annular_tissue_vel , int mv_grad_p_p , int mv_pressure_half_time , int mv_grad_mean , int mv_plenimetric_area , int mv_propagation_vel , int mv_ivrt , int mv_deceleration_time , int mv_doppler_area , int mv_grad_max , String mv_regur_wave_area_short , String mv_summary , String mv_regur_wave_choosed , String mv_regur_desc_choosed , int av_peak_regur_vel , int av_ea_early_to_latediast_trans_aortic_flow_vel , int av_eeprim_early_diastolic_aortic_annular_tissue_vel , int av_grad_p_p , int av_pressure_half_time , int av_grad_mean , int av_plenimetric_area , int av_propagation_vel , int av_ivrt , int av_deceleration_time , int av_doppler_area , int av_grad_max , String av_regur_wave_area_short , String av_summary , String av_regur_wave_choosed , String av_regur_desc_choosed , int tv_peak_regur_vel , int tv_ea_early_to_latediast_trans_tricuspid_flow_vel , int tv_eeprim_early_diastolic_tricuspid_annular_tissue_vel , int tv_grad_p_p , int tv_pressure_half_time , int tv_grad_mean , int tv_plenimetric_area , int tv_propagation_vel , int tv_ivrt , int tv_deceleration_time , int tv_doppler_area , int tv_grad_max , String tv_regur_wave_area_short , String tv_summary , String tv_regur_wave_choosed , String tv_regur_desc_choosed , int pv_peak_regur_vel , int pv_ea_early_to_latediast_trans_pulmonic_flow_vel , int pv_eeprim_early_diastolic_pulmonic_annular_tissue_vel , int pv_grad_p_p , int pv_pressure_half_time , int pv_grad_mean , int pv_plenimetric_area , int pv_propagation_vel , int pv_ivrt , int pv_deceleration_time , int pv_doppler_area , int pv_grad_max , String pv_regur_wave_area_short , String pv_summary , String pv_regur_wave_choosed , String pv_regur_desc_choosed , String pv_diastolic_function_choosed , String ot_contratility_choosed) {
    ...
    this.mv_ea_early_to_latediast_trans_mitral_flow_vel = mv_ea_early_to_latediast_trans_mitral_flow_vel;
    this.mv_eeprim_early_diastolic_mitral_annular_tissue_vel = mv_eeprim_early_diastolic_mitral_annular_tissue_vel;
    ...
    this.av_ea_early_to_latediast_trans_aortic_flow_vel = av_ea_early_to_latediast_trans_aortic_flow_vel;
    this.av_eeprim_early_diastolic_aortic_annular_tissue_vel = av_eeprim_early_diastolic_aortic_annular_tissue_vel;
    ...
    this.tv_ea_early_to_latediast_trans_tricuspid_flow_vel = tv_ea_early_to_latediast_trans_tricuspid_flow_vel;
    this.tv_eeprim_early_diastolic_tricuspid_annular_tissue_vel = tv_eeprim_early_diastolic_tricuspid_annular_tissue_vel;
    ...
    this.pv_ea_early_to_latediast_trans_pulmonic_flow_vel = pv_ea_early_to_latediast_trans_pulmonic_flow_vel;
    this.pv_eeprim_early_diastolic_pulmonic_annular_tissue_vel = pv_eeprim_early_diastolic_pulmonic_annular_tissue_vel;
