...
public class BackendPropertyReader {
  ...
  private static final Logger log =
      LogManager.getLogger(net.wilamowski.drecho.client.properties.ClientPropertyReader.class);
  ...
  public static String getString(String key) {
    try (InputStream input =
        net.wilamowski.drecho.client.properties.ClientPropertyReader.class.getResourceAsStream(
            PROPERTIES_PATH)) {
      if (input == null) {
