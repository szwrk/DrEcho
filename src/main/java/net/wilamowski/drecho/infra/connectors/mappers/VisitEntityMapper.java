...
import net.wilamowski.drecho.standalone.domain.visit.PatientNotFoundException;
import net.wilamowski.drecho.standalone.domain.visit.UserNotFoundException;
import net.wilamowski.drecho.standalone.domain.visit.Visit;
import net.wilamowski.drecho.standalone.domain.visit.VisitEntity;
