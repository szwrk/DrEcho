 ...
 */
@Deprecated
public class EchoCardioCalculatorLvmi implements EchoCardioCalculator {
  ...
  private static final Logger logger = LogManager.getLogger( EchoCardioCalculatorLvmi.class);

  public EchoCardioCalculatorLvmi() {
