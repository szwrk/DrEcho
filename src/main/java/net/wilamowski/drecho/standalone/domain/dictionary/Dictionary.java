package net.wilamowski.drecho.standalone.domain.dictionary;
...
public class Dictionary {
  ...
  public void enablePosition(String positionName) {
    positions.stream().filter(pos -> pos.getCode().equals(positionName)).forEach(Position::enable);
  }

  public void disablePosition(String positionName) {
    positions.stream().filter(pos -> pos.getCode().equals(positionName)).forEach(Position::disable);
  }
