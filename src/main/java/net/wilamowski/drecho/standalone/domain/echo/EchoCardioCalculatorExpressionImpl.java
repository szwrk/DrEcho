...
public class EchoCardioCalculatorExpressionImpl implements EchoCardioCalculator {
  ...
  private static final Logger logger = LogManager.getLogger( EchoCardioCalculatorExpressionImpl.class);
