...
public abstract class ConnectorLayer {
  public static ConnectorLayer createServiceLayerAsStandalone(StandaloneRepositoryFactory standaloneRepositoryFactory) {
      return new ConnectorLocalModel(standaloneRepositoryFactory);
    }
  public static ConnectorLayer createServiceLayerAsProxy(StandaloneRepositoryFactory standaloneRepositoryFactory) {
    return new ConnectorLocalModel(standaloneRepositoryFactory);
  }
