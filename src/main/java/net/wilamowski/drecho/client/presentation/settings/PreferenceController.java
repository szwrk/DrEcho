 ...
 */
    ...
    public class PreferenceController
            ...
            PostInitializable {
        private static final Logger logger = LogManager.getLogger( net.wilamowski.drecho.client.presentation.settings.SettingsController.class);
        @FXML
        private TableView<SettingPropertyFx> table;
