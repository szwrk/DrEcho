...
public class CalculatorViewModel {
    ...
    public Double calcLvm(IntegerProperty dm_left_ventricle_diastole, IntegerProperty dm_iv_septum_diastole, IntegerProperty  dm_posterior_wall_diastole) {
        if (validateLvmInputs(dm_left_ventricle_diastole,dm_iv_septum_diastole,dm_posterior_wall_diastole)) {
...
public Double calcRwt(IntegerProperty dm_posterior_wall_diastole, IntegerProperty dm_left_ventricle_diastole){
    ...
    private boolean validateRwtInputs(IntegerProperty dm_posterior_wall_diastole, IntegerProperty dm_left_ventricle_diastole) {
  ...
  ,IntegerProperty dm_posterior_wall_diastole) {
    if (validateLvmIndexInputs(dm_posterior_wall_diastole, dm_iv_septum_diastole, dm_left_ventricle_diastole)) {
      logger.debug("Start calculating RWT...");
      Double v =
