...
public class BudowanieElementowTestApp {
    ...
    private static String textField(String fxId) {
        return String.format( "               <TextField fx:id=\"%1$s\" prefWidth=\"500.0\" promptText=\"%1$s\" />\n",fxId);
    }
    ...
    private static String label(String key) {
        return String.format("                  <Label alignment=\"CENTER_RIGHT\" minWidth=\"100.0\" prefWidth=\"200.0\" text=\"%1$s\">\n",key);
    }
    ...
    private static List<String> readLinesFromFile() {
        final String path = "C://Users//Arek//_PROJEKTY//_echokardioLg//echo_tte_etykiety_angielskie.properties";
