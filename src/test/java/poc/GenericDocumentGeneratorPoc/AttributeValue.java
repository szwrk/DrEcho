...
public class AttributeValue {
  ...
  private static final Logger log = LogManager.getLogger(AttributeValue.class);
   ...
   * @throws IllegalArgumentException If the attribute type specified in {@code definition} is not
   *     "TEXT".
   */
  public static AttributeValue create(
      Integer instanceDocumentId, AttributeDefinition definition, String textValue) {
    ...
    if (definition.getType().equals("TEXT")) {
      ...
      return new AttributeValue(
          instanceDocumentId, attributeClass, attributeCode, type, textValue, null);
    } else {
      log.error(
          "Creating attibuteValue failed. Parameter doesn't exists: {}", definition.getType());
      throw new IllegalArgumentException(
          "Creating attibuteValue failed. Parameter doesn't exists: " + definition.getType());
    }
  }

  private static void parametersCheckNull(
      Integer instanceDocumentId,
      String attributeClass,
      String attributeCode,
      String containedDataType) {
    StringBuilder sb =
        new StringBuilder(
            "Null values are not allowed. Please provide non-null values for the following parameters:");
   ...
   */
  public static AttributeValue create(
      Integer instanceDocumentId, AttributeDefinition definition, BigDecimal numericValue) {
    Objects.requireNonNull(definition, "Definicja atrybutu nie moze być pusta");
    if (definition.getType().equals("NUM")) {
      ...
      return new AttributeValue(
          ...
          type,
          null,
          numericValue.stripTrailingZeros());
    } else {
      log.error("Creating attibuteValue failed. Parameter dosnt exists: {}", definition.getType());
      throw new IllegalArgumentException(
          "Creating attibuteValue failed. Parameter dosnt exists: " + definition.getType());
    }
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(rootId, attribute.rootId)
        && Objects.equals(classType, attribute.classType)
        && Objects.equals(dataType, attribute.dataType)
        && Objects.equals(textValue, attribute.textValue)
        && Objects.equals(numberValue, attribute.numberValue)
        && Objects.equals(classCod, attribute.classCod);
  }
